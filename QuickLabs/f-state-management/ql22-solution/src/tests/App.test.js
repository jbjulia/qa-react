...
import {act as tlract, render} from '@testing-library/react';
...
describe(`Conditional renders dependent on result of data calls`, () => {
    ...
    // xtest('should display the modal when getError is truthy', async () => {
    ...
    //   const modal = await screen.findByText(/todo application error/i);
    ...
    // xtest('should display the modal when postError state is truthy from a post request', async () => {
    ...
    // xtest('should display the modal when putError state is true from a put request', async () => {
    //   axios.get.mockResolvedValue({ data: sampleTodos });
    ...
    // xtest('should close the modal for a get error when the button to close it is clicked', async () => {
    ...
    // xtest('should close the modal for a post error when the button to close it is clicked', async () => {
    ...
    // xtest('should close the modal for a put error when the button to close it is clicked', async () => {
